...
<div class="w3-row w3-padding-64" id="about">
 ...
 src="https://www.youtube.com/embed/Feww-tndO04"> 
    ...
    <div class="w3-col m6 w3-padding-large">
      <h1 class="w3-center" style="font-family:Bell MTBell MT;color:white;">haak</h1><br>
      
      <p class="w3-large"style="font-family:Bell MT;color:white;">The abbrivation haak is Knowledge And Fun ONline. It is one of the website where we can find all kind of books from childern to elders.
